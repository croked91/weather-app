...
import { $currentCity, getCurrentCity } from "features/address-suggestions/model"
import { WrappedAdressSuggestions } from "features/address-suggestions/ui"
import { $citiesWeather, deleteItem, Gate, getCityWeatherFX, reloadCityWeatherFX } from "features/weather-screen/model"
...
export const Weather = () => {
    ...
    const mapWeather = citiesWeather && citiesWeather.map(
        el => <WeatherCard
